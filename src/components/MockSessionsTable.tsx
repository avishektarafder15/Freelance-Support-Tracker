...
interface MockSessionsTableProps {
  sessions: MockInterviewSession[];
}

export const MockSessionsTable: React.FC<MockSessionsTableProps> = ({ sessions }) => {
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden flex flex-col h-full">
      ...
      <div className="p-4 border-b border-gray-100 bg-gray-50/50 flex flex-wrap items-center justify-between gap-4">
        <div className="relative flex-1 min-w-[300px]">
          ...
          <input
            type="text"
            placeholder="Search mock interview sessions by name, email, mentor..."
      ...
      <div className="flex-1 overflow-auto">
        <table className="w-full text-left border-collapse min-w-[2200px]">
          <thead className="sticky top-0 z-10">
            <tr className="bg-gray-50 border-b border-gray-200">
              ...
              <th className="px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Session Type</th>
        ...
        {filteredSessions.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-gray-400">
            ...
            <p className="text-lg font-medium">No mock interview sessions found matching your search.</p>
          </div>
        )}
      </div>
      ...
      <div className="p-4 border-t border-gray-100 bg-gray-50 flex items-center justify-between text-xs text-gray-500">
        <div>Total Mock Interview Sessions: <span className="font-bold text-gray-700">{filteredSessions.length}</span></div>
